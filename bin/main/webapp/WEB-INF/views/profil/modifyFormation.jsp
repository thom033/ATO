...
<div class="container" style="margin-top: 5%;">
  <div class="row" ng-app="FormationApp" ng-controller="tableController">
    <div class="col-md-6">
      <div class="form">
        <form id="formulaire" ng-submit="submitForm()">
          <div class="container">
            <h5>Formation utilisateur</h5>
            <hr>
          </div>
          <div class="row mb-3">
            <p>Secteur</p>
            <div class="col-md-5">
                <select class="form-select" aria-label="Default select example" ng-model="formation.diplome">
                    <option ng-repeat="diplome in diplomes" ng-value="{{diplome}}" ng-selected="diplome.diplome==formation.diplome">{{diplome.diplome}}</option>
                </select>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-5">
              <div class="input-group">
                  <input required="" value="{{formation.dateDebut.split('T')[0]}}" type="date" id="dateDebut" auto complete="off" class="input" style=" border-radius: 15px;">
          ...
          <div class="row mb-3">
            <div class="col-md-5">
              <div class="input-group">
                  <input value="{{formation.dateFin.split('T')[0]}}" type="date" id="dateFin" autocomplete="off" class="input" style=" border-radius: 15px;">
          ...
          <div class="row mb-3">
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <textarea class="form-control" ng-model="formation.description" aria-label="With textarea"></textarea>
                </div>
            </div>
          </div>
          <div class="row">
...
<script src="/public/js/crud/Formation.js"></script>
