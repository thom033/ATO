...
<div class="container">
  <div class="row" ng-app="EntrepriseContactApp" ng-controller="tableController">
    <div class="col-md-6">
      <div class="form">
        <form id="formulaire" ng-submit="submitForm()">
          ...
          <div class="row mb-3" ng-repeat="contact in entreprise.contacts">
            <div class="col-md-6">
...
<script src="../../../public/js/crud/EntrepriseContact.js"></script>
