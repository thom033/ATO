                ...
                <div class="content">
                    ...
                    <div class="row" >
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control mb-2" placeholder="Description" ng-model="experience.descriptiom" class="input" autocomplete="off">
                        </div>
                    </div>
                    <p>Date Debut</p>
                        <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input required="" type="date" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="experience.dateDebut">
                         ...
                         <div class="row">
                                 <div class="col-md-3 mb-3">
                                     <div class="input-group">
                                         <div class="input-group">
                                             <input required="" type="date" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="experience.dateFin" >
                                             <label class="user-label">  </label>
                                         </div>
                                     </div>
                                 </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select"  ng-model="experience.idUtilisateur" class="input" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select" name="secteur" id="secteur" ng-model="experience.secteur" class="input" autocomplete="off">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr ng-repeat="poste in postes">
                                <th scope="row">{{experience.idExperience}}</th>
                                <td>{{experience.idUtilisateur}}</td>
                                <td>{{experience.dateDebut}}</td>
                                <td>{{experience.dateFin}}</td>
                                <td><button class="btn btn-warning" ng-click="modify(experience.idExperience)">Modifier</button></td>
                                <td><button class="btn btn-danger" ng-click="delete(experience.idExperience)">Supprimer</button></td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
