                ...
                <div class="content">
                    ...
                    <div class="row" >
                        <div class="input-group">
                            <input type="text" class="form-control mb-2" placeholder="Tapez le nom de votre diplome" ng-model="diplome.diplome" class="input" autocomplete="off">
                        </div>
                    </div>
                    <p>  Identite du secteur </p>
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select" name="secteur" id="secteur" ng-model="diplome.secteur" class="input" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="input-group">
                                    <div class="input-group">
                                        <input required="" type="number" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="diplome.niveau" class="input" autocomplete="off">
                                        <label class="user-label"> Niveau </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr ng-repeat="poste in postes">
                                    <th scope="row">{{diplome.idDiplome}}</th>
                                    <td>{{diplome.diplome}}</td>
                                    <td>{{diplome.niveau}}</td>
                                    <td><button class="btn btn-warning" ng-click="modify(diplome.idDiplome)">Modifier</button></td>
                                    <td><button class="btn btn-danger" ng-click="delete(diplome.idDiplome)">Supprimer</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
