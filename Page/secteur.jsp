...
<body style="background-image: url(assets/img/recherche.png);">
    ...
    <div class="row" ng-app="AdminApp" ng-controller="tableController"></div>
        ...
        <div class="card">
                ...
                <div class="content">
                    ...
                    <div class="row" >
                        ...
                        <div class="input-group">
                            <input required type="text" ng-model="secteur.secteur" class="input" autocomplete="off" class="form-control mb-2" placeholder="Tapez votre secteur ">
                        </div>
                    </div>
                        <dz iv class="col-md-3 mb-3"> 
            ...
            <div class="col-md-5">
                <table class="table">
                    ...
                    <tbody>
                        <tr ng-repeat="secteur in secteurs">
                            <th scope="row">{{secteur.idSecteur}}</th>
                            <td>{{secteur.secteur}}</td>
                            <td><button class="btn btn-warning" ng-click="modify(secteur.idSecteur)">Modifier</button></td>
                            <td><button class="btn btn-danger" ng-click="delete(secteur.idSecteur)">Supprimer</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <script src="../../../../public/js/crud/Secteur.js"></script>
