...
<body style="background-image: url(assets/img/recherche.png);">
                ...
                <div class="content">
                    ...
                    <div class="row" >
                        <div class="input-group">
                            <input type="text" class="form-control mb-2" placeholder="Competence" ng-model="competence.competence" class="input" autocomplete="off">
                        </div>
                    </div>
                        <p> Description </p>
                        <div class="row" >
                            <div class="input-group">
                                <input type="text" class="form-control mb-2" placeholder="Description" ng-model="competence.description" class="input" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr ng-repeat="poste in postes">
                                    <th scope="row">{{competence.idCompetence}}</th>
                                    <td>{{competence.competence}}</td>
                                    <td><button class="btn btn-warning" ng-click="modify(competence.idCompetence)">Modifier</button></td>
                                    <td><button class="btn btn-danger" ng-click="delete(competence.idCompetence)">Supprimer</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script src="../../../../public/js/crud/Competence.js"></script>
