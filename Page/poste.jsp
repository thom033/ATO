                ...
                <div class="content">
                    ...
                    <form id="formulaire" ng-submit="submitForm()">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                        ...
                                        <input required="" type="file" ng-model="poste.image"name="text" class="input" autocomplete="off"  accept="image/*">
                    ...
                    <div class="row" >
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control mb-2" placeholder="Titre" ng-model="poste.titre" class="input" autocomplete="off">
                            <div class="col-md-3 mb-3">
                            </div>
                        </div>
                       
                        <div class="input-group">
                            <input type="text" class="form-control mb-2" placeholder="Description" ng-model="poste.description" class="input" autocomplete="off">
                        </div>
                        <div class="col-md-3 mb-3">
                        </div>
                        </form>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="input-group">
                                    <div class="input-group">
                                        <input required="" type="number" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="poste.age" >
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                <div class="input-group">
                                    <input required="" type="number" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="poste.salaire" >
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select" name="diplome" id="diplome" ng-model="poste.diplome" class="input" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select" name="secteur" id="secteur" ng-model="poste.secteur" class="input" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select" name="Entreprise" id="Entreprise" ng-model="poste.idEntreprise" class="input" autocomplete="off">
                                    <option value="" class="option">Entreprise</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="input-group">
                                    <div class="input-group">
                                        <input required="" type="number" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="poste.experience" >
                                        <label class="user-label"> Nbr Annee EXP </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input required="" type="number" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="poste.formation">
                                            <label class="user-label"> Nbr Annee Formation </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input required="" type="date" name="text" autocomplete="off" class="input" style=" border-radius: 15px;" ng-model="poste.dateInsertion">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr ng-repeat="poste in postes">
                                <th scope="row">{{poste.idPoste}}</th>
                                <td>{{poste.dateInsertion}}</td>
                                <td>{{poste.titre}}</td>
                                <td><button class="btn btn-warning" ng-click="modify(poste.idPoste)">Modifier</button></td>
                                <td><button class="btn btn-danger" ng-click="delete(poste.idPoste)">Supprimer</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
