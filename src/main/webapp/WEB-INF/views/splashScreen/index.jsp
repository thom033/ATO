...
<body style="background: var(--bs-body-bg);">
    <nav class="navbar navbar-expand-md sticky-top navbar-shrink py-3 navbar-light" id="mainNav" style="margin-bottom: -1px;padding-bottom: 30px;padding-top: 0px;">
        <div class="container"><img class="img-fluid" src="/public/img/rohy1.png" style="margin-top: -32px;margin-bottom: -21px;margin-left: -33px;width: 150px;"><a class="navbar-brand d-flex align-items-center" href="/"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1" style="font-size: large;margin-bottom: -2px;font-family: Aleo, serif;">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link active" href="index.html" style="font-family: 'Space Grotesk';">Acceuil</a></li>
                    <li class="nav-item"><a class="nav-link active" href="#" style="font-family: 'Space Grotesk';">Statistique</a></li>
                    <li class="nav-item"><a class="nav-link active" href="#" style="font-family: 'Space Grotesk';">Mes Notifications</a></li>
                    <li class="nav-item"><a class="nav-link active" href="#" style="font-family: 'Space Grotesk';">ChatBot</a></li>
                </ul>
                    ...
                    </svg></span><img style="width: 30px;height: 30px;border-radius: 100px;" src="/public/img/branch.jpeg"></a>
        </div>
    </nav>
    <header class="bg-primary-gradient">
        <div class="container pt-4 pt-xl-5" style="background: var(--bs-body-bg);">
            <div class="row pt-5" style="background: url(&quot;/public/img/acceuil.png&quot;) center / cover, var(--bs-body-bg);margin-bottom: -52px;padding-top: 0px;margin-top: -48px;width: 100%;">
    ...
    <section class="py-5 mt-5" style="background: var(--bs-emphasis-color);padding-top: 0px;margin-bottom: -42px;margin-top: -44px;">
