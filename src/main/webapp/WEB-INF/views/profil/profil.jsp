        ...
        <div class="row">
            <div class="col-md-3 col-lg-3">
                ...
                <div class="button-info">
                    <div class="my-2"><form action="/utilisateur/modify"><button style="background-color: #fff; border-color: #000; color: #000;" class="btn btn-primary shadow" type="submit">Compléter vos informations</button></div>
