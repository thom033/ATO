    ...
    <div class="notification-container" ng-app="frontApp" ng-controller="entretienController" >
            ...
            <div ng-repeat="entretien in entretiens" class="notification-item row align-items-center" style="padding-top: 20px;">
                <div class="col-1 text-center pl">
                    <a href="" ng-click="valider(entretien.id)"><span class="notification-icon download" style="margin-left: 40px;"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                        <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
                        <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
                    </svg></span></a>
                </div>
                <div class="col-1 text-center">
                    <a href="" ng-click="delete(entretien.id)"><span class="notification-icon garbage"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
