...
public class Notification {
    ...
    // ---- ---- CONSTRUCTEURS ------- ------
        public Notification() {}
        public Notification(Long idNotification, String message, LocalDateTime dateNotification, LocalDateTime dateLu, Utilisateur utilisateur, TypeNotification type) {
